...
# Las variables son unidad de almacenamiento y recuperacion de datos cona valores que pueden cambiar, la cual se identifica con un nombre unico en el codigo del programa.
